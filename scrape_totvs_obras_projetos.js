...
/**
 * =============================================================================
 * Scraper: TOTVS Obras e Projetos — Central de Atendimento (Zendesk HC)
 * =============================================================================
 * Faz scrape recursivo de todas as seções e artigos da Central de Atendimento
 * TOTVS para a Obras e Projetos, convertendo o conteúdo HTML em Markdown organizado
 * por seção/subseção.
 *
 ...
 *   node scrape_totvs_obras_projetos.js [--delay 800] [--output ./totvs_obras_projetos]
 *
 * =============================================================================
 */
...
const START_SECTION =
  "/hc/pt-br/sections/1500000595741-Obras-e-Projetos";
...
function parseArgs() {
  ...
  for (let i = 0; i < args.length; i++) {
    switch (args[i]) {
      ...
      case "-h":
        console.log(`
Uso: node scrape_totvs_obras_projetos.js [opções]

Opções:
  -o, --output <dir>         Diretório de saída (default: ./totvs_obras_projetos)
...
function buildSectionIndex(outputDir) {
  ...
  if (indexEntries.length > 0) {
    const idxLines = [
      "# 📚 TOTVS Obras e Projetos — Índice Consolidado por Seção",
      "",
...
function createIndex(outputDir) {
  const lines = [
    "# 📚 TOTVS Obras e Projetos — Central de Atendimento",
    "",
...
async function main() {
  ...
  console.log(
    "🚀 Scraper TOTVS Obras e Projetos — Central de Atendimento"
  );
  console.log("=".repeat(70));
  ...
  try {
    // Scrape recursivo
    const rootName = "TOTVS Obras e Projetos";
